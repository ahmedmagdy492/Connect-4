...
public:
	...
	int Render() {
	  Vector2 texturePos = { (float)(screenWidth - logo.width)/2, (float)-100};
		...
		Vector2 titlePos = { (float)(screenWidth - titleSize.x) / 2, (float)200 };
		...
		Vector2 winWord2Pos = { (float)(screenWidth - winWord2Size.x) / 2, (float)winWordPos.y + winWordSize.y + 20 };
		...
		Vector2 winWord3Pos = { (float)(screenWidth - winWord3Size.x) / 2, (float)winWord2Pos.y + winWord2Size.y + 20 };
